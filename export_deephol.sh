...
#--vocab_file=bert/model/vocab.txt --output_dir=gs://zpp-bucket-1920/tpu-fine-tune/exported/new_4_lr \
#--init_checkpoint=gs://zpp-bucket-1920/tpu-fine-tune/models/new_4_lr/model.ckpt-360000 --max_seq_length=512 \
