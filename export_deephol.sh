...
--vocab_file=bert/model/vocab.txt --output_dir=gs://zpp-bucket-1920/tpu-fine-tune/exported/wavenet_losses \
--init_checkpoint=gs://zpp-bucket-1920/tpu-fine-tune/models/wavenet_losses/model.ckpt-3330000 --max_seq_length=512 \
