...
--vocab_file=bert/model/vocab.txt --output_dir=gs://zpp-bucket-1920/tpu-fine-tune/exported/masking_best \
--init_checkpoint=gs://zpp-bucket-1920/tpu-fine-tune/models/masking_best/model.ckpt-360000 --max_seq_length=512 \
