...
--vocab_file=bert/model/vocab.txt --output_dir=gs://zpp-bucket-1920/tpu-fine-tune/exported/params_cond_on_tac_bert \
--init_checkpoint=gs://zpp-bucket-1920/tpu-fine-tune/models/params_cond_on_tac_bert/model.ckpt-903935 --max_seq_length=512 \
