...
--vocab_file=bert/model/vocab.txt --output_dir=gs://zpp-bucket-1920/tpu-fine-tune/exported/wavenet_new \
--init_checkpoint=gs://zpp-bucket-1920/tpu-fine-tune/models/wavenet_new/model.ckpt-333000 --max_seq_length=512 \
