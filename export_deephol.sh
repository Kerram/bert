...
--vocab_file=bert/model/vocab.txt --output_dir=gs://zpp-bucket-1920/tpu-fine-tune/exported/wavenet_full_brackets \
--init_checkpoint=gs://zpp-bucket-1920/tpu-fine-tune/models/wavenet_full_brackets/model.ckpt-3330000 --max_seq_length=512 \
