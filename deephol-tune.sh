...
--vocab_file=bert/model/vocab.txt --output_dir=gs://zpp-bucket-1920/tpu-fine-tune/models/wavenet_full \
...
--train_file=gs://zpp-bucket-1920/tpu-fine-tune/data/train_wavenet.tf_record
