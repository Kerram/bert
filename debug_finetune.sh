...
--vocab_file=bert/model/vocab.txt --output_dir=gs://zpp-bucket-1920/tpu-fine-tune/models/weighted_params_wavenet \
...
--eval_file=gs://zpp-bucket-1920/tpu-fine-tune/data/weighted/valid_mini.tf_record \
--infinite_eval=True
